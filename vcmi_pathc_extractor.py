...
if __name__ == "__main__":
    images_per_device = Path("/Users/marynavek/Projects/files/ten_devices_frames_ds_1/test")
    patches_per_device = Path("/Users/marynavek/Projects/files/ten_devices_vcmi_patches/test")
