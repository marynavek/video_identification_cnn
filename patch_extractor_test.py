...
if __name__ == "__main__":
    images_per_device = Path('/Users/marynavek/Projects/files/experiment_new_phones/15_dev_train_test_frames/test/')

    patches_per_device_top_rigth = Path('/Users/marynavek/Projects/files/experiment_new_phones/sector_1_patch/test/')
    patches_per_device_bottom_right = Path('/Users/marynavek/Projects/files/experiment_new_phones/sector_2_patch/test/')
    patches_per_device_top_left = Path('/Users/marynavek/Projects/files/experiment_new_phones/sector_3_patch/test/')
    patches_per_device_bottom_left = Path('/Users/marynavek/Projects/files/experiment_new_phones/sector_4_patch/test/')
