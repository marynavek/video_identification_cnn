import argparse
from dataset_creation.prepare_dataset_frames import DataSetGeneratorFrames
from model_files.constrained_net_frames import ConstrainedNetTransferFrames
...
if __name__ == "__main__":
    ...
    data_factory = DataSetGeneratorFrames(input_dir_frames=dataset_path,
    ...
    constr_net = ConstrainedNetTransferFrames(constrained_net=use_constrained_layer)
    if model_path:
