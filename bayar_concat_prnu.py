...
from data_gen_concat_prnu import DataGeneratorBayar
...
class BayarModelNet:
    ...
    def __generate_model_path(self):
        path_base = "/Users/marynavek/Projects/video_identification_cnn/experiment_std"
    ...
    def create_model(self, num_classes, model_name=None):
        ...
        conv2d_4 = Conv2D(32, (5,5), strides=(1,1),padding='same')(max_pool2)
        ...
        input_std_patch = Input(1,)
        input_std_quadrant = Input(1,)

        merge_layer = tf.keras.layers.concatenate([flatten, input_std_patch, input_std_quadrant], axis=1)

        dense1 = Dense(100)(merge_layer)
        ...
        model = Model(inputs=(input_layer, input_std_patch, input_std_quadrant), outputs=final_dense)
