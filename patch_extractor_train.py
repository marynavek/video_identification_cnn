...
def get_patches(img_data, std_threshold, max_num_patches):
    ...
    num_channels = 3
    default_patch_std = np.std(img_data.reshape(-1, num_channels), axis=0)
    # Choose the patches
...
if __name__ == "__main__":
    images_per_device = Path('/Users/marynavek/Projects/files/experiment_new_phones/15_dev_train_test_frames/train/')

    patches_per_device_top_rigth = Path('/Users/marynavek/Projects/files/experiment_new_phones/sector_1_patch/train/')
    patches_per_device_bottom_right = Path('/Users/marynavek/Projects/files/experiment_new_phones/sector_2_patch/train/')
    patches_per_device_top_left = Path('/Users/marynavek/Projects/files/experiment_new_phones/sector_3_patch/train/')
    patches_per_device_bottom_left = Path('/Users/marynavek/Projects/files/experiment_new_phones/sector_4_patch/train/')
