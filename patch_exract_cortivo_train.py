...
def get_patches(img_data, std_threshold, max_num_patches):
    ...
    # # dafault_path_mean = np.mean(img_data.reshape(-1, num_channels), axis=0)
    # # Choose the patches
...
if __name__ == "__main__":
    images_per_device = Path('/Users/marynavek/Projects/files/experiment_cortivo/train_test_frames/train/')

    patches_per_device_top_rigth = Path('/Users/marynavek/Projects/files/experiment_cortivo/patches/train/')
    patches_per_device_bottom_right = Path('/Users/marynavek/Projects/files/experiment_cortivo/sector_2_patches/train/')
    patches_per_device_top_left = Path('/Users/marynavek/Projects/files/experiment_cortivo/sector_3_patches/train/')
    patches_per_device_bottom_left = Path('/Users/marynavek/Projects/files/experiment_cortivo/sector_4_patches/train/')
