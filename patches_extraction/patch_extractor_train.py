...
if __name__ == "__main__":
    images_per_device = Path('/Users/marynavek/Projects/Video_Project/dataset/train/')
    patches_per_device = Path('/Users/marynavek/Projects/Video_Project/patches/train/')
