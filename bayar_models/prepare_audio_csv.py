...
class DataSetGeneratorBayar:
    ...
    def create_train_dataset_after_selection(self):
        ...
        path = "/Users/marynavek/Projects/video_identification_cnn/binary_results_sector_4_.csv"
        selected_paths = []
        with open(path, newline='') as csvfile:
            ...
            for i, file_path in enumerate(train_input_patchs_file_names):
                if file_path in selected_paths:
                    ...
                    ds_row = {"item_ID": count, "patch_path": file_path, "class_label": class_label}
    ...
    def create_test_ds_4_sectors(self, test_path_ds_1, test_path_ds_2, test_path_ds_3, test_path_ds_4):
        ...
        # with open("predictions_dataset.csv", "w") as file:
        #     keys = ["item_ID", "sector_1_patch", "sector_2_patch", "sector_3_patch", "sector_4_patch", "class_label"]
    ...
    def create_train_ds_4_sectors_after_selection(self, train_path_ds_1, train_path_ds_2, train_path_ds_3, train_path_ds_4):
        ...
        labeled_dictionary = list()
        # sorted_input_patches_sector1 = self.select_pathches(patches_sel_file_1, train_input_patches_file_names_sector1)
        # sorted_input_patches_sector2 = self.select_pathches(patches_sel_file_2, train_input_patches_file_names_sector2)
        # sorted_input_patches_sector3 = self.select_pathches(patches_sel_file_3, train_input_patches_file_names_sector3)
        # sorted_input_patches_sector4 = self.select_pathches(patches_sel_file_4, train_input_patches_file_names_sector4)
        # # random.shuffle(sorted_input_patches_sector1)
    ...
    def create_test_ds_4_sectors_after_selection(self, train_path_ds_1, train_path_ds_2, train_path_ds_3, train_path_ds_4):
