...
from vcmi_data_gen_patch import DataGeneratorVCMI
...
class ConstrainedNet:
    # GLOBAL_SAVE_MODEL_DIR = "/Users/marynavek/Projects/video_identification_cnn/vcmi_exp/constrained_test/"
    # GLOBAL_TENSORBOARD_DIR = "/Users/marynavek/Projects/video_identification_cnn/vcmi_exp/constrained_test/"

    def __init__(self, model_path_name, tensor_flow_path, model_path = None, constrained_net=True):
        ...
        self.global_save_model_dir = self.__generate_model_path(model_path_name)
    ...
    def __generate_model_path(self, model_path):
        ...
        new_path = os.path.join(model_path)
        return new_path
    ...
    def __generate_tensor_path(self, tensor_flow_path):
        ...
        new_path = os.path.join(tensor_flow_path)
        return new_path
    ...
    def create_model(self, num_output, fc_layers=2, fc_size=1024, height=128, width=128, model_name=None):
        ...
        opt = tf.keras.optimizers.SGD(lr=0.001, momentum=0.95, decay=0.0005)
    ...
    def train(self, train_ds, val_ds_test, num_classes):
        ...
        self.model.fit(DataGeneratorVCMI(train_ds, num_classes=num_classes, batch_size=32),
                       epochs=50,
                       initial_epoch=0,
                       validation_data=DataGeneratorVCMI(val_ds_test, num_classes=num_classes, batch_size=32, shuffle=False),
                       callbacks=callbacks,
                       workers=12,
