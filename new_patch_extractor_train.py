...
if __name__ == "__main__":
    images_per_device = Path('/Users/marynavek/Projects/files/experiment_23/30_dev_train_test_frames/train/')

    patches_per_device_top_rigth = Path('/Users/marynavek/Projects/files/experiment_23/sector_1_patch/train/')
    patches_per_device_bottom_right = Path('/Users/marynavek/Projects/files/experiment_23/sector_2_patch/train/')
    patches_per_device_top_left = Path('/Users/marynavek/Projects/files/experiment_23/sector_3_patch/train/')
    patches_per_device_bottom_left = Path('/Users/marynavek/Projects/files/experiment_23/sector_4_patch/train/')
