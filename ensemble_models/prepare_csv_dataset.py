...
class DataSetGeneratorBayar:
    ...
    def create_val_ds_4_sectors_after_selection(self, train_path_ds_1, train_path_ds_2, train_path_ds_3, train_path_ds_4):
        train_input_patches_file_names_sector1 = np.array(glob(str(os.path.join(train_path_ds_1, "val")) + "/**/*.jpg", recursive = True))
        train_input_patches_file_names_sector2 = np.array(glob(str(os.path.join(train_path_ds_2, "val")) + "/**/*.jpg", recursive = True))
        train_input_patches_file_names_sector3 = np.array(glob(str(os.path.join(train_path_ds_3, "val")) + "/**/*.jpg", recursive = True))
        train_input_patches_file_names_sector4 = np.array(glob(str(os.path.join(train_path_ds_4, "val")) + "/**/*.jpg", recursive = True))
        labeled_dictionary = list()
