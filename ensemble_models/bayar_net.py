...
class HPCBayarModelNet:

    def __init__(self, sector, patch_type, model_path, tensor_flow_path):
        self.sector = sector
    ...
    def __generate_model_path(self, model_path):
        ...
        new_path = os.path.join(model_path, self.patch_type, self.sector)
        return new_path
    ...
    def __generate_tensor_path(self, tensor_flow_path):
        ...
        new_path = os.path.join(tensor_flow_path, self.patch_type, self.sector)
        return new_path
    ...
    def create_model(self, num_classes, model_name=None):
        ...
        # conv2d_1 = Conv2D(96, (5,5), strides=(2,2),padding='same', activity_regularizer=tf.keras.regularizers.l2(0.01))(constrained_conv_layer)
        ...
        # conv2d_2 = Conv2D(64, (3,3), strides=(1,1),padding='same', activity_regularizer=tf.keras.regularizers.l2(0.01))(max_pool1)
        ...
        # conv2d_4 = Conv2D(64, (3,3), strides=(1,1),padding='same', activity_regularizer=tf.keras.regularizers.l2(0.01))(max_pool2)
        ...
        # conv2d_5 = Conv2D(64, (3,3), strides=(1,1),padding='same')(max_pool4)
