...
from predictions.frames_prediction_stats import FramePredictionStatistics
from predictions.frames_prediction_visualization import FramePredictionVis
from predictions.frames_predictor import PredictFrames
...
if __name__ == "__main__":
    ...
    for model_file in model_files:
        ...
        dataset_factory = DataSetGeneratorFrames(input_dir_frames=frames_ds_path,
